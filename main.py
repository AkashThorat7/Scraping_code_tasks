...
# def store_html_data(data,tags):

#     conn = sqlite3.connect("data.db")
#     cursor = conn.cursor()

#     cursor.execute("CREATE TABLE IF NOT EXISTS task_data(id INTEGER PRIMARY KEY AUTOINCREMENT,data TEXT,html_tag TEXT )")
#     cursor.execute("INSERT INTO task_data(data,html_tag) VALUES(?,?) (data,html_tag)")
...
#     print('html data is scraped sucessfully')

#     tags  = extract_tag(data)

#     store_html_data(data,tags)
